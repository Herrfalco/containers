...
class	Multimap
{
	public:
		...
		~Multimap(void);
		Multimap					&operator=(const Multimap &l);
...
class	Multimap<Key, T, Compare>::value_compare :
...
template <class Key, class T, class Compare>
bool
Multimap<Key, T, Compare>::value_compare::operator()(const value_type &x,
...
///Multimap functions definitions
template <class Key, class T, class Compare>
Multimap<Key, T, Compare>::Multimap(const key_compare &comp) : _comp(comp), _root(0), _front(),
	_back(), _size(0)
{
	_front.type = lft;
	_back.type = rht;
...
template <class Key, class T, class Compare>
template <class InputIterator>
Multimap<Key, T, Compare>::Multimap(InputIterator first, InputIterator last,
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::rec_insert(const MapNode<value_type> *n)
{
	if (!n || !n->valptr)
		return ;
	insert(*(n->valptr));
...
template <class Key, class T, class Compare>
Multimap<Key, T, Compare>::~Multimap(void)
{
	clear();
}
...
&Multimap<Key, T, Compare>::operator=(const Multimap &m)
{
	if (&m == this)
		return (*this);
	clear();
...
template <class Key, class T, class Compare>
bool
Multimap<Key, T, Compare>::empty(void) const
{
	return (_size ? false : true);
}

template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::size_type
Multimap<Key, T, Compare>::size(void) const
{
	return (_size);
}
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::size_type
Multimap<Key, T, Compare>::max_size(void) const
{
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::iterator
Multimap<Key, T, Compare>::insert(const value_type &val)
{
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::iterator
Multimap<Key, T, Compare>::insert(iterator it, const value_type &val)
{
	(void)it;
	insert(val);
}
...
template <class InputIterator>
void
Multimap<Key, T, Compare>::insert(InputIterator fst, InputIterator lst)
{
	for (; fst != lst; ++fst)
		insert(*fst);
}
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::left_splice(iterator position)
{
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::right_splice(iterator position)
{
	MapNode<value_type>		*ptr = position._node;
	MapNode<value_type>		*a;
	MapNode<value_type>		*b;
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::root_splice(iterator position)
{
	MapNode<value_type>		*ptr = position._node;
	MapNode<value_type>		*a;
	MapNode<value_type>		*b;
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::erase(iterator position)
{
	MapNode<value_type>		*ptr = position._node;
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::size_type
Multimap<Key, T, Compare>::erase(const key_type &k)
{
	iterator	it;
	size_type	count;

	for (count = 0; (it = lower_bound(k)) != upper_bound(k); ++count)
		erase(it);
	return (count);
}
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::erase(iterator first, iterator last)
{
	iterator		tmp(first++);
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::swap(Multimap &x)
{
...
template <class Key, class T, class Compare>
void
Multimap<Key, T, Compare>::clear(void)
{
	while (_size)
		erase(begin());
}
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::key_compare
Multimap<Key, T, Compare>::key_comp(void) const
{
	return (key_compare());
}

template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::value_compare
Multimap<Key, T, Compare>::value_comp(void) const
{
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::iterator
Multimap<Key, T, Compare>::find(const key_type &k)
{
	iterator	it(begin());
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::const_iterator
Multimap<Key, T, Compare>::find(const key_type &k) const
{
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::size_type
Multimap<Key, T, Compare>::count(const key_type &k) const
{
	const_iterator		it(begin());
	size_type			count;
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::iterator
Multimap<Key, T, Compare>::lower_bound(const key_type &k)
{
	iterator	it(begin());
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::const_iterator
Multimap<Key, T, Compare>::lower_bound(const key_type &k) const
{
	const_iterator	it(begin());
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::iterator
Multimap<Key, T, Compare>::upper_bound(const key_type &k)
{
	iterator	it(begin());
...
template <class Key, class T, class Compare>
typename Multimap<Key, T, Compare>::const_iterator
Multimap<Key, T, Compare>::upper_bound(const key_type &k) const
{
	const_iterator	it(begin());
...
template <class Key, class T, class Compare>
ft::Pair<typename Multimap<Key, T, Compare>::const_iterator,
	typename Multimap<Key, T, Compare>::const_iterator>
Multimap<Key, T, Compare>::equal_range(const key_type &k) const
{
	return (ft::make_pair(lower_bound(k), upper_bound(k)));
}

template <class Key, class T, class Compare>
ft::Pair<typename Multimap<Key, T, Compare>::iterator,
	typename Multimap<Key, T, Compare>::iterator>
Multimap<Key, T, Compare>::equal_range(const key_type &k)
{
	return (ft::make_pair(lower_bound(k), upper_bound(k)));
}
